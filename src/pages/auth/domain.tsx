...
import DomainForm from "@/components/forms/auth-forms/domain-form";
...
const LeftBox: FC = () => {
  return (
    <div className="relative hidden bg-[#0a0a0a] max-h-screen h-screen flex-col p-10 text-white lg:flex justify-center">
      <div>
        ...
        <div className="relative z-20 my-3 2xl:my-10">
          <h1 className="text-4xl text-center gradient-title 2xl:text-6xl lg:text-left 2xl:mb-10 mb-4">
    ...
    <div className="lg:p-8 max-h-screen h-screen flex items-center justify-center bg-black">
      <div className="w-[calc(100%-50px)] min-[450px]:w-[400px] sm:w-[500px] text-center space-y-4 text-white">
        ...
        <p className="text-2xl lg:text-xl pb-1 font-medium">
          Welcome back ! Enter your domain
        </p>
